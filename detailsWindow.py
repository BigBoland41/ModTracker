...
class DetailsWindow(object):
    ...
    def __init__(self, window, modList, priorityList, selectedVersion):
        # assign variables
    ...
    def reloadWidgets(self, rowNum, reloadEverything = False):
    ...
    def _addMod(self):
        ...
        self._modTable.setModList(self._modList)
        #print(self._tableWidget.getModList()[0])
        self.reloadWidgets()
